...
const CampaignTable: React.FC = () => {
  ...
  const data = useAppSelector((state) => state.campaignsList)
  ...
  useEffect(() => {
    if (campaigns) {
      ...
      dispatch(setTotalItems(campaigns?.meta?.totalItems))
    }
    dispatch(setLoading(isLoading))
  }, [campaigns, isLoading, dispatch])
  ...
  return (
    <>
      <DataTable
        ref={tableRef}
        columns={columns}
        data={data?.campaigns} // data?.campaigns ⚠️
