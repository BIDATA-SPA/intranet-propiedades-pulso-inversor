  ...
  return (
    <>
                    ...
                    <AdaptableCard>
                      <div className="relative w-full flex justify-center items-center">
                        <FormItem
                          ...
                          label="¿Te gustaría iniciar una campaña de marketing con nosotros para mejorar la imagen de tu página web, aumentar tu visibilidad y atraer más clientes?"
                        >
                              ...
                              {({ field, form }: FieldProps) => (
                                <Select
                                  ...
                                  value={serviceTypesOptions?.filter(
                                    (option: TSelect) =>
                                      option.value === '1' ||
                                      option.label === 'Campaña publicitaria'
                                  )}
                                  onChange={(option) =>
                                    form.setFieldValue(
                                      field.name,
      ...
      {showInfoDialog && (
        ...
        >
          <h5 className="mb-4">Beneficios - Campaña publicitaria</h5>
          <BenefitItems />
          <div className="text-right mt-6">
