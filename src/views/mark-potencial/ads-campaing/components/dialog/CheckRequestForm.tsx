...
const CheckRequestForm = ({ onClose, brand }: UpdateExchangeFormProps) => {
                ...
                <div className="card-body flex flex-col lg:flex-row items-center w-full gap-4">
                  <div className="flex flex-col items-start justify-start text-start w-full">
                    <div className="flex flex-col md:flex-row">
                      <h6>Esperando la respuesta del administrador/a</h6>
                    </div>
                    <div className="w-full">
                      <p className="text-gray-400">
                        Esto puede tardar dependiendo el rango estimado de
                        contacto que se establecio en la solicitud.
                      </p>
                    </div>
                  </div>
                </div>
