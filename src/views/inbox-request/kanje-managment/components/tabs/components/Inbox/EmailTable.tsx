...
import { useGetExchangeEmailInboxQuery } from '@/services/RtkQueryService'
...
import { TbClockEdit, TbStars } from 'react-icons/tb'
...
const EmailTable = ({
  ...
  const { data: emails, isFetching } = useGetExchangeEmailInboxQuery(
    {
      page: currentPage || 1,
      limit: pageSize,
    },
          ...
          return (
            <>
              <div
                ...
                onClick={() => onShowUpdate(cellProps.row.original)}
              >
                <span
          ...
          return (
            <div className="flex items-center justify-center">
              {latestContract?.applicantSignature ? (
                ...
                <Tooltip title="Firma pendiente: Corredor solicitante">
                  <span className="cursor-pointer flex items-center text-yellow-500 font-semibold">
                    <TbClockEdit className="text-xl mr-1" />
                    Pendiente
                  </span>
                </Tooltip>
              )}
        ...
        cell: (cellProps) => {
          ...
          return (
            <div className="flex items-center justify-around">
              <Tooltip title="Actualizar y Firmar">
                <span
                  className="cursor-pointer"
                  onClick={() => onShowUpdate(cellProps.row.original)}
                >
                  <FiEdit className="text-lg hover:text-yellow-500" />
                </span>
              </Tooltip>
