...
const ExternalServicesRequestManagment = () => {
  const [currentTab, setCurrentTab] = useState('sent')
  const navigate = useNavigate()

  const onTabChange = (tabId: string) => {
    setCurrentTab(tabId)
    navigate(`/gestion-de-solicitud-de-servicios/${tabId}`)
  }

  return (
    <Container className="h-full">
      <AdaptableCard>
        <h1 className="text-lg md:text-xl mb-5">Solicitudes de Servicios</h1>
...
export default ExternalServicesRequestManagment
