...
const VisitOrderRent: FC<VisitOrderDocumentProps> = (props) => {
  return (
    <VisitOrderLayout
      {...props}
      showCompanyFooter
    ...
    >
      ...
      <p>
        ...
        profesionales, la suma equivalente al 50% más IVA del valor de un mes de
        arriendo por contratos de hasta 24 meses; en el caso de arriendos a
        plazos superiores a 2 años, los honorarios serán de un 2% más IVA del
        total de rentas a percibir en el período del contrato. Los honorarios
        señalados se pagarán al contado mediante transferencia al momento de la
