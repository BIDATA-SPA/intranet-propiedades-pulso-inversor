...
const StadisticsClicks = ({dataClicks}) => {
    ...
    const parseToPercent = () => {
        const totalClicks = Object.values(dataClicks).reduce((acc, val) => acc + val, 0);
        // const percentClicks = {}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 overflow-hidden my-2 mt-4 sm:mx-5 p-4 sm:p-2">
                <article className="flex flex-col group items-center p-2 py-3 w-full h-44 sm:h-40 rounded-md border border-sky-500 drop-shadow-2xl hover:scale-105 duration-200">
                    ...
                    <div className="text-center mt-3">
                        <span className="font-semibold  ">{dataClicks?.clickOfMoreOfRealtor} <small>veces</small></span>
                ...
                <article className="flex flex-col group items-center p-2 py-3 w-full h-44 sm:h-40 rounded-md border border-sky-500 drop-shadow-2xl hover:scale-105 duration-200">
                    ...
                    <div className="text-center mt-3">
                        <span className="font-semibold">{dataClicks?.clickOfNameRealtor} <small>veces</small></span>
                        <p className="font-normal mb-3 sm:text-xs">Han hecho clic a tu nombre</p>
                        <div  className="text-md sm:text-xs">
                ...
                <article className="flex flex-col group items-center p-2 py-3 w-full h-44 sm:h-40 rounded-md border border-sky-500 drop-shadow-2xl hover:scale-105 duration-200">
                    ...
                    <div className="text-center mt-3">
                        <span className="font-semibold">{dataClicks?.clickOfOpenContact} <small>veces</small></span>
                        <p className="font-normal mb-3 sm:text-xs">Han revisado tu contacto</p>
                        <div  className="text-md sm:text-xs">
                ...
                <article className="flex flex-col group items-center p-2 py-3 w-full h-44 sm:h-40 rounded-md border border-sky-500 drop-shadow-2xl hover:scale-105 duration-200">
                    ...
                    <div className="text-center mt-3">
                        <span className="font-semibold">{dataClicks?.clickOfSendContact} <small>veces</small></span>
                        <p className="font-normal mb-3 sm:text-xs">Te han enviado un correo</p>
                        <div  className="text-md sm:text-xs">
                ...
                <article className="flex flex-col group items-center p-2 py-3 w-full h-44 sm:h-40 rounded-md border border-sky-500 drop-shadow-2xl hover:scale-105 duration-200">
                    ...
                    <div className="text-center mt-3">
                        <span className="font-semibold">{dataClicks?.clickOfWebPage } <small>veces</small></span>
                        <p className="font-normal mb-3 sm:text-xs">Han visitado tu sitio web</p>
                        <div  className="text-md sm:text-xs">
    ...
    return(
        <>
            <div className="text-center mb-4 sm:mb-2 mt-4 sm:mt-2 sm:mx-14">
                ...
                <small>
                    en la web oficial
                {' '}<a className='text-sky-600 underline underline-offset-1 italic' href='https://procanje.com/portal-corredores' target='_blank' rel='noreferrer'>
                    Procanje.com
                </a>
                </small>
            </div>
