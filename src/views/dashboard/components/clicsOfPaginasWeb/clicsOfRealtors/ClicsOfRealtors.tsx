    ...
    return(
        ...
        <article className="shadow-md group group-hover:blur-lg h-96 w-full sm:h-full border border-1 rounded-md overflow-hidden overflow-y-auto">
            <div className='mx-3 m-2'>
                ...
                <small>realizados en portal corredores en página web oficial <a className='underline underline-offset-1 italic' href='https://procanje.com/portal-corredores' target='_blank' rel='noreferrer'>Procanje</a></small>
            </div>
            { hasClicks ? (
            <>
                <Chart
