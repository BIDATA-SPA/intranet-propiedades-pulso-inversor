...
import GridCard from './PropertiesResumeGridCard'

const PropertiesResumeGrid: React.FC = () => {
  const dispatch = useAppDispatch()

  // Obtener las propiedades y el estado de carga desde el store
  const properties = useSelector(
    (state: RootState) => state.propertiesResumeList.data.propertiesResume
  )
...
export default PropertiesResumeGrid
