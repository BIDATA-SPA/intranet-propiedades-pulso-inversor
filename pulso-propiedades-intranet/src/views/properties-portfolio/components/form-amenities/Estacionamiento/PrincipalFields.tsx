  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-0 md:grid-cols-2 xl:grid-cols-3 md:gap-3">
        ...
        <FormItem label="Estac. Simple">
          <Field name="characteristics.hasSimpleParking">
            {({ field, form }: FieldProps) => {
              return (
                <Switcher
                  checked={values.characteristics?.hasSimpleParking}
                  className="my-3"
                  onChange={() => {
                    form.setFieldValue(
                      field.name,
                      !values.characteristics?.hasSimpleParking
                    )
                  }}
                />
              )
        ...
        <FormItem label="Estac. Doble">
          <Field name="characteristics.hasDoubleParking">
            {({ field, form }: FieldProps) => {
              return (
                <Switcher
                  checked={values.characteristics?.hasDoubleParking}
                  className="my-3"
                  onChange={() => {
                    form.setFieldValue(
                      field.name,
                      !values.characteristics?.hasDoubleParking
                    )
                  }}
                />
              )
        ...
        <FormItem label="Subterráneo">
          <Field name="characteristics.hasSubway">
            {({ field, form }: FieldProps) => {
              return (
                <Switcher
                  checked={values.characteristics?.hasSubway}
                  className="my-3"
                  onChange={() => {
                    form.setFieldValue(
                      field.name,
                      !values.characteristics?.hasSubway
                    )
                  }}
                />
              )
